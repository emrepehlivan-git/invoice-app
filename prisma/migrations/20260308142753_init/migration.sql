...
-- CreateIndex
CREATE UNIQUE INDEX "ExchangeRate_organizationId_fromCurrency_toCurrency_effecti_key" ON "ExchangeRate"("organizationId", "fromCurrency", "toCurrency", "effectiveDate");
